...
| 功能 | 描述 | 优先级 | 状态 |
|------|------|--------|------|
| 时间范围 | 日/周/月/年切换 | P0 | ✅ 已完成 |
| 总时长 | 显示选中范围的总时长 | P0 | ✅ 已完成 |
| 饼图 | 活动分布占比 | P0 | ✅ 已完成 |
| 柱状图 | 时间趋势变化 | P0 | ✅ 已完成 |
| 类别统计 | 按类别独立显示统计，类别切换 | P1 | ✅ 已完成 |
...
| 功能 | 描述 | 优先级 | 状态 |
|------|------|--------|------|
| 深色模式 | 浅色/深色/跟随系统三种模式 | P0 | ✅ 已完成 |
| 外观设置 | 主题颜色自定义 | P1 | ✅ 已完成 |
| 通知 | 计时提醒、成就解锁提醒 | P1 | ✅ 已完成 |
| 声音 | 提示音开关 | P1 | ✅ 已完成 |
| 数据管理 | 清除所有数据 | P0 | ✅ 已完成 |
...
### v1.0 (已完成 - 2026-01-23)
- ✅ 基础计时功能（开始/暂停/恢复/停止，累计时间跟踪）
- ✅ 历史记录（日期/分类双视图，记录详情）
- ✅ 统计图表（按类别统计，类别切换）
- ✅ 成就系统
- ✅ 设置（深色模式，外观设置二级页面）
- ✅ 类别系统（预设 + 自定义类别）
- ✅ 灵动岛 & Live Activity（暂停状态同步，主题同步）
- ✅ 间隔提醒功能

### v1.1 (计划中)
- 成就徽章增强（渐变背景、解锁动画、发光效果）
- 单元测试和 UI 测试
